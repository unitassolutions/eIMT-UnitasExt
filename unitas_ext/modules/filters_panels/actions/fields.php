...
switch($app_module_action)
{
    case 'save':
        ...
        redirect_to('unitas_ext/filters_panels/fields', 'panels_id=' . $panels_id . '&redirect_to=' . $app_redirect_to . '&entities_id=' . $_GET['entities_id']);
    ...
    case 'sort':
        ...
        redirect_to('unitas_ext/filters_panels/fields', 'entities_id=' . $_GET['entities_id'] . '&redirect_to=' . $app_redirect_to . '&panels_id=' . $panels_id);
        break;
}
