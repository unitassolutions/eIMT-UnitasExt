...
$breadcrumb[] = '<li>' . link_to($entity_info['name'],url_for('unitas_ext/pivot_map_reports/entities','reports_id=' . $pivot_map_info['id'])) . '<i class="fa fa-angle-right"></i></li>';
...
<div class="panel panel-default">
  <div class="panel-heading"><?php echo TEXT_FILTERS_FOR_ENTITY . ': <b>' . $entity_info['name'] . '</b>' ?></div>
    ...
    <?php echo button_tag(TEXT_BUTTON_ADD_NEW_REPORT_FILTER,url_for('unitas_ext/pivot_map_reports/filters_form','map_reports_id=' . $pivot_map_info['id'] . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param)) ?>
    ...
    ?>
      <tr>
        <td style="white-space: nowrap;"><?php echo button_icon_delete(url_for('unitas_ext/pivot_map_reports/filters_delete','map_reports_id=' . $pivot_map_info['id'] . '&id=' . $v['id'] . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param)) . ' ' . button_icon_edit(url_for('unitas_ext/pivot_map_reports/filters_form','map_reports_id=' . $pivot_map_info['id'] . '&id=' . $v['id'] . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param))  ?></td>    
...
<?php echo '<a class="btn btn-default" href="' . url_for('unitas_ext/pivot_map_reports/entities','reports_id=' . $pivot_map_info['id']) . '">' . TEXT_BUTTON_BACK. '</a>'; ?>  
