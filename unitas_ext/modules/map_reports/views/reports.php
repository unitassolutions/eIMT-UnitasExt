...
<?php echo button_tag(TEXT_BUTTON_CREATE,url_for('unitas_ext/map_reports/form')) ?>
...
while($reports = db_fetch_array($reports_query)):
    ...
    $public_url = url_for('unitas_ext/map_reports/public','id=' . $reports['id']);
?>
<tr>
  <td style="white-space: nowrap;"><?php echo button_icon_delete(url_for('unitas_ext/map_reports/delete','id=' . $reports['id'])) . ' ' . button_icon_edit(url_for('unitas_ext/map_reports/form','id=' . $reports['id'])) ?></td>
  ...
  <td>
      <?php echo link_to($reports['name'], url_for('unitas_ext/map_reports/view','id=' . $reports['id'])) ?>
      <?php 
